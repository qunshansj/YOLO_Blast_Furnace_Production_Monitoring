...
![3.png](68f51130adf3dae22b066ea92cc573c8.png)

![4.png](3fe8e2a316103f8c87cde2eb08cb9c40.png)
...
[[YOLOv7]基于YOLOv7的转炉生产监控系统(源码＆部署教程)_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1Ze411M7Nu/?vd_source=bc9aec86d164b67a7004b996143742dc)
...
![5.png](44cc418a9163d6d00e270458bd004c2e.png)
...
## 该研究的主要贡献包括：
[参考该博客提出的创新点](https://mbd.pub/o/bread/Y5WYl5lv)
...
![6.png](a1cb0414090269ca90368bff733d92ec.png)
[该博客提出的 E-ELAN 完全没有改变原有架构的梯度传输路径](https://afdian.net/item?plan_id=2985eece617011ed97bc52540025c377)，其中使用组卷积来增加添加特征的基数（cardinality），并以 shuffle 和 merge cardinality 的方式组合不同组的特征。这种操作方式可以增强不同特征图学得的特征，改进参数的使用和计算效率。
...
![7.png](b0e08cec1f338a1fe670d82187fed718.png)

# 5.数据集的准备
## 标注收集到的图片制作YOLO格式数据集（文末提供下载链接）
![6.png](daf086e09040bbf5f84e09dd3db34dd4.png)

![7.png](97c8cb6dedbef1237cd311fcca762555.png)

自己创建一个myself.yaml文件用来配置路径，路径格式与之前的V5、V6不同，只需要配置txt路径就可以
![8.png](5bfad56da9cbc0edfc679f418d906fad.png)

![9.png](aa5f8d12ba89bfc2246408de52081b86.png)
 train-list.txt和val-list.txt文件里存放的都是图片的绝对路径（也可以放入相对路径）
![12.png](49a0fca3174626b5229c1c82d89eaeca.png)
...
![13.png](bcd1c902ddb7ee961aba526b5ce30a16.png)

路径修改完之后右击运行即可
![14.png](693f053f26ef5f42f933422c8b529279.png)
...
附上推荐设备配置
![16.jpg](ffcf44ced3aca422352926c55fc0474e.jpeg)


# 7.测试验证
下面放上对比图：（上面V7，下面V5）
![15.png](798372a58ebe5ba6dae606766e7cb4e9.png)


# 8.系统整合
下图[完整源码&环境部署视频教程&数据集&自定义UI界面](https://s.xiaocichang.com/s/e77fe9)
![1.png](d02c9efdf8ae956714929c16736c55e1.png)
